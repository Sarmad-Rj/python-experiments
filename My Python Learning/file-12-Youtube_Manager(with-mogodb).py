...
client = MongoClient("mongodb+srv://sarmad:sarmad@cluster0.9fo6ata.mongodb.net/", tlsAllowInvalidCertificates=True)
# ofc not a good idea to include id pass in file...
